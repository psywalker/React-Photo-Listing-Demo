...
describe('Test of component of PhotoCard', () => {
  it('Test state PhotoCard dive props', () => {
    ...
    const card = shallow(<BrowserRouter><LastLocationProvider><PhotoCard {...props} /></LastLocationProvider></BrowserRouter>)
  ...
  it('Test state PhotoCard props', () => {
    ...
    const card = mount(<BrowserRouter><LastLocationProvider><PhotoCard {...props} /></LastLocationProvider></BrowserRouter>)
  ...
  it('Test state PhotoCard booleans', () => {
    ...
    const card1 = mount(<BrowserRouter><LastLocationProvider><PhotoCard {...props1} /></LastLocationProvider></BrowserRouter>)
    ...
    const card2 = mount(<BrowserRouter><LastLocationProvider><PhotoCard {...props2} /></LastLocationProvider></BrowserRouter>)
  ...
  it('Test snapshot PhotoCard component', () => {
    const card = shallow(<BrowserRouter><LastLocationProvider><PhotoCard /></LastLocationProvider></BrowserRouter>)
